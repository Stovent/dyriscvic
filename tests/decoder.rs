...
fn decode_i64() {
    ...
    let slliw_ = Instruction::from_opcode_32(0, slliw);
    type_i(&slliw_, Isa::SLLIW, 30, 5, 4);

    let sllw = 0b0000000_10110_10001_001_10011_0111011u32;
    let sllw_ = Instruction::from_opcode_32(0, sllw);
    ...
    let sraiw_ = Instruction::from_opcode_32(0, sraiw);
    type_i(&sraiw_, Isa::SRAIW, 1050, 5, 4);

    let sraw = 0b0100000_10110_10001_101_10011_0111011u32;
    let sraw_ = Instruction::from_opcode_32(0, sraw);
