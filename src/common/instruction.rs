...
impl Instruction {
    ...
    pub fn empty(inst: Isa, pc: u64, _: u32) -> Self {
        Self { inst, pc, rd: 0, rs1: 0, rs2: 0, imm: 0 }
    }

    pub fn decode_type_r(inst: Isa, pc: u64, opcode: u32) -> Self {
    ...
    pub fn decode_type_i(inst: Isa, pc: u64, opcode: u32) -> Self {
        let rd = (opcode >> 7 & 0b1_1111) as u8;
        let rs1 = (opcode >> 15 & 0b1_1111) as u8;
    ...
    pub fn decode_type_s(inst: Isa, pc: u64, opcode: u32) -> Self {
        let rs1 = (opcode >> 15 & 0b1_1111) as u8;
        let rs2 = (opcode >> 20 & 0b1_1111) as u8;
    ...
    pub fn decode_type_b(inst: Isa, pc: u64, opcode: u32) -> Self {
        let rs1 = (opcode >> 15 & 0b1_1111) as u8;
        let rs2 = (opcode >> 20 & 0b1_1111) as u8;
    ...
    pub fn decode_type_u(inst: Isa, pc: u64, opcode: u32) -> Self {
        let rd = (opcode >> 7 & 0b1_1111) as u8;
        let imm = opcode as i32 & 0xFFFF_F000;
        Instruction { inst, pc, rd, rs1: 0, rs2: 0, imm }
    }

    pub fn decode_type_j(inst: Isa, pc: u64, opcode: u32) -> Self {
        let rd = (opcode >> 7 & 0b1_1111) as u8;
